...
public class SudoFriendServiceImpl extends AppCompatActivity implements StartGameService {
    ...
    public void move() {
        countDownTimer.cancel();
        Intent intent1 = new Intent(getApplicationContext(), SudoFriendServiceImpl.class);
