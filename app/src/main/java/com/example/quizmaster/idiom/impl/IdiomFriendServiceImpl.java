...
public class IdiomFriendServiceImpl extends AppCompatActivity implements StartGameService {
    ...
    public void start(Intent intent) {
        ...
        if (stage == 1) {
            ...
            String query = "SELECT * FROM QuizList WHERE queGb = 'idiom' ";
    ...
    public void move() {
        countDownTimer.cancel();
        Intent intent1 = new Intent(getApplicationContext(), IdiomFriendServiceImpl.class);
